					...
					<div class="card-body">
						<form class="needs-validation" action="procesarAdmin.php" method="post">
							<div class="row">
								...
								<div class="col-6"> <input class="form-control" type="text" name="txtCiudad" required /></div>
							</div><br/><br/>

							<div class="row">
								<div class="col-5"></div>
								<div class="col-2" style="text-align:center">
									<input class="btn btn-primary" style='background-color:#12bfb5; border-color:#12bfb5; width:125px'type="submit" value="Ingresar"></div>
								</div>

								<input type="hidden" name="txtAccion" value="ingresarCiudad">
							</form>
						</div>

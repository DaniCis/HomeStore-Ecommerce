			...
			<main class='container'>
				<div class="card text-center">
					<div class="card-header">
						<h5>Eliminar Categorías</h5>
					</div>
					<div class="card-body">
						<form action="procesarAdmin.php" method="post">
							<div class="row">
								<div class="col-2">Id</div>
								<div class="col-2"><input  class="form-control" type="text" name="txtId" value="<?= $id_categoria ?>" readonly></div>
							</div><br/>
							<div class="row">
								<div class="col-2">Nombre</div>
								<div class="col-5"> <input class="form-control" type="text" name="txtCategoria" value="<?=$nombre ?>" readonly></div>
							</div><br/><br/>
							<div class="row">
							<div class="col-5"></div>
							...
							<input type="hidden" name="txtAccion" value="eliminarCategoria">
						</form>
						</div>

					...
					<div class="card-body">
						<form action="procesarAdmin.php" method="post">
							<div class="row">
								...
								<div class="row">
									<div class="col-2">Ciudad:</div><div class="col-1"> <input class="form-control" type="text" name="txtCiudad" value="<?=$nombre ?>" readonly></div></div><br/>
									<br/><br/>
									<div class="row">
										<div class="col-5"></div>
									...
									<input type="hidden" name="txtAccion" value="eliminarCiudad">
								</form>
							</div>
